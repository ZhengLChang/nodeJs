...
_24f.mask=$("<div class=\"window-mask\"></div>").insertAfter('body');
_24f.mask.css({width:(_253().width),height:(_253().height),display:"none"});
}
if(_24f.shadow){
_24f.shadow.remove();
}
if(_24f.options.shadow==true){
_24f.shadow=$("<div class=\"window-shadow\"></div>").insertAfter('body');
